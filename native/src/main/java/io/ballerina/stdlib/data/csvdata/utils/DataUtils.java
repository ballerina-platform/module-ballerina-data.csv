...
// */
//
//package io.ballerina.stdlib.data.csvdata.csv.utils;
//
...
//import io.ballerina.stdlib.data.csvdata.csv.FromString;
//import io.ballerina.stdlib.data.csvdata.csv.QualifiedName;
//
...
//
//import javax.csv.namespace.QName;
//
///**
...
//    public static QualifiedName validateAndGetCsvNameFromRecordAnnotation(RecordType recordType, String recordName,
...
//                    throw DiagnosticLog.error(DiagnosticErrorCode.TYPE_NAME_MISMATCH_WITH_CSV_ELEMENT, name, localPart);
//                }
//                localName = name;
//                break;
//            }
...
//    }
//
//    public static void validateRequiredFields(BMap<BString, Object> currentMapValue, CsvAnalyzerData analyzerData) {
...
//                    TypeTags.CSV_TAG, TypeTags.NULL_TAG -> TypeCreator.createArrayType(type);
...
//                    TypeTags.CSV_TAG, TypeTags.NULL_TAG -> TypeCreator.createMapType(constraintType);
...
//    }
//
//    public static void updateExpectedTypeStacks(RecordType recordType, CsvAnalyzerData analyzerData) {
...
//    }
//
//    public static void removeExpectedTypeStacks(CsvAnalyzerData analyzerData) {
...
//                            ValueCreator.createMapValue(TypeCreator.createMapType(PredefinedTypes.TYPE_CSV));
...
//                return jsonMap;
//            }
//            case TypeTags.CSV_TAG -> {
//                ArrayType csvArrayType = TypeCreator.createArrayType(PredefinedTypes.TYPE_CSV);
//                BMap<BString, Object> jsonMap =
//                        ValueCreator.createMapValue(TypeCreator.createMapType(csvArrayType));
//                for (Map.Entry<BString, Object> entry : input.entrySet()) {
//                    BArray arrayValue = (BArray) entry.getValue();
//                    BArray csvArrayValue = ValueCreator.createArrayValue(csvArrayType);
//                    for (int i = 0; i < arrayValue.getLength(); i++) {
//                        csvArrayValue.append(arrayValue.get(i));
//                    }
//                    jsonMap.put(entry.getKey(), csvArrayValue);
//                }
//                return jsonMap;
//            }
//            default -> {
...
//        BString prefix = (BString) namespaceAnnotation.get(Constants.PREFIX);
//        if (prefix ==  null) {
//            subRecord.put(StringUtils.fromString(ATTRIBUTE_PREFIX + "csvns"), uri);
//        } else {
//            subRecord.put(StringUtils.fromString(ATTRIBUTE_PREFIX + "csvns:" + prefix), uri);
//            key = prefix.getValue().concat(Constants.COLON).concat(key);
//        }
//        return key;
//    }
...
//     * @since 0.1.0
//     */
//    public static class CsvAnalyzerData {
//        public boolean mapContext = false;
//    }
//}
